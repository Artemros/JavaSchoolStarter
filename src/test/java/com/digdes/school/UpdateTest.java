...
public class UpdateTest {
    ...
    @Test
    public void updateTestID4() throws Exception {
        JavaSchoolStarter jss = new JavaSchoolStarter();
        List<Map<String, Object>> data = new ArrayList<>();
        Map<String,Object> row3 = new HashMap<>();
        row3.put("id",3L);
        ...
        List<Map<String, Object>> updated = jss.execute("UPDATE VALUES ‘active’=false, ‘cost’=10.1, ‘age’=30  where ‘id’=3");
        Assertions.assertIterableEquals(data, updated);
        //System.out.println(jss.getJssList());
    }

    @Test
    public void updateTestID5() throws Exception {
        JavaSchoolStarter jss = new JavaSchoolStarter();
        List<Map<String, Object>> data = new ArrayList<>();
        Map<String,Object> row3 = new HashMap<>();
        row3.put("id",3L);
