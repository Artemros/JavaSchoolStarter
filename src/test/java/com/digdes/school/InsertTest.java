...
public class InsertTest {
    ...
    @Test
    public void insertUnknownColumnTest1() throws Exception {
        JavaSchoolStarter jss = new JavaSchoolStarter();
        List<Map<String, Object>> data = new ArrayList<>();
        IllegalArgumentException thrown = Assertions.assertThrows(IllegalArgumentException.class, () -> {
            List<Map<String, Object>> selected = jss.execute("INSERT VALUES ‘smth’ = ‘Петров’ , ‘id’=1, ‘age’=30, ‘active’=true");
        });
    }
    @Test
    public void insertWithSpaceColumnTest1() throws Exception {
        JavaSchoolStarter jss = new JavaSchoolStarter();
        List<Map<String, Object>> data = new ArrayList<>();
        Map<String,Object> row1 = new HashMap<>();
        row1.put("id",1L);
